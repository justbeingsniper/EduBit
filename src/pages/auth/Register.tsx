  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="text-center text-4xl font-bold text-gray-900 mb-2">EduBit</h2>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <div className="text-xs mt-1">Watch & learn</div>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <div className="text-xs mt-1">Teach & share</div>
                </button>
              </div>
            </div>
          </div>
